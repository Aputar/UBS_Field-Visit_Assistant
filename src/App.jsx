...
const STORAGE_KEY = "ubs_fieldos_data";

const defaultData = {
  users: [
    { id: "u1", name: "Rajesh Mehta", role: "ZRH", region: "West (Guj + Mumbai)", password: "admin123" },
    { id: "u2", name: "Vikram Shah", role: "TRH", region: "Gujarat North", password: "trh123" },
    { id: "u3", name: "Priya Desai", role: "RE", region: "Ahmedabad", password: "re123" },
  ],
  depots: [
  ...
  dealers: [
    { id: "d1", name: "ABC UBS", code: "GJ-001", depot: "Ahmedabad", city: "Ahmedabad", trhId: "u2", reId: "u3", contact: "9876543210" },
    { id: "d2", name: "Sunrise Hardware", code: "GJ-045", depot: "Rajkot", city: "Rajkot", trhId: "u2", reId: "u3", contact: "9876543211" },
  ],
  visits: [
    {
      ...
      createdBy: "u1", trhId: "u2", reId: "u3"
    }
  ],
  actions: [
    { id: "a1", visitId: "v1", dealerId: "d1", title: "Arrange Opus branding artwork", detail: "Full display kit for paint section", assignedTo: "u2", priority: "High", deadline: "2025-05-28", category: "Displays & Branding", status: "Open", remarks: "", createdBy: "u1", depot: "Ahmedabad" },
    { id: "a2", visitId: "v1", dealerId: "d1", title: "Conduct PVC product training", detail: "Schedule half-day training with dealer staff", assignedTo: "u3", priority: "Medium", deadline: "2025-05-30", category: "PVC", status: "In Progress", remarks: "Date being fixed", createdBy: "u1", depot: "Ahmedabad" },
    { id: "a3", visitId: null, dealerId: "d2", title: "Appoint sanitary distributor", detail: "Identify and onboard distributor for Saurashtra", assignedTo: "u2", priority: "High", deadline: "2025-05-25", category: "Sanitary", status: "Open", remarks: "", createdBy: "u1", depot: "Rajkot" },
  ],
  trhs: [
